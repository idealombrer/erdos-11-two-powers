...
drift to $\ep\approx900$; scripts \texttt{typeA\_garcia\_voloch\_check.py},
\texttt{typeA\_exceptional\_band.py}.\textup{)}
\end{proof}
...
\texttt{typeB\_supnorm\_check.py}). The counter-example (4.23) in \cite{BourgainChang2006},
...
(script \texttt{typeB\_wall\_first\_moment.py}), the fraction of $n$ with a nonzero (B)-contribution
